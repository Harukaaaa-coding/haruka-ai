...
def parse_args():
    parser = argparse.ArgumentParser(description="QLoRA SFT for GopherAI's local chat model")
    parser.add_argument("--model", default=DEFAULT_MODEL)
    parser.add_argument("--data", default="training/data/sft.example.jsonl")
    parser.add_argument("--eval-data", help="Optional JSONL validation set in the same SFT format")
    parser.add_argument("--output", default="training/outputs/sft-adapter")
